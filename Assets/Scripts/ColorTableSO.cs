...
{
    [SerializeField] GameplayColorSO[] gameplayColorsData; // should hold aaaall the gameplay colors so 
    [SerializeField] MixtureColorSO[] mixtureColorsData; // should hold aaaall the mixture colors so 
    ...
    public GameplayColorSO[] GetGameplayColors(List<ColorItemID> idsList)
    {
        ...
        {
            var id = idsList[i];
            t[i] = gameplayColorsData.First(x => x.colorItemSO.colorItemID == id);
        }
    ...
    public MixtureColorSO[] GetMixtureColors(List<ColorItemID> idsList)
    {
        ...
        {
            var id = idsList[i];
            t[i] = mixtureColorsData.First(x => x.colorItemSO.colorItemID == id);
        }
    ...
    {
        return gameplayColorsData.First(x => x.colorItemSO.colorItemID == id);
    }

    public MixtureColorSO GetMixtureColor(ColorItemID id)
    {
        return mixtureColorsData.First(x => x.colorItemSO.colorItemID == id);
    }
}